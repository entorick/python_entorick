...
# 由于python不能直接将包含小数点的字符串转化为整数
# 先将字符串转换为浮点数float，在将浮点数转化为整数int。
exit()


# 'dict_keys' object does not support item assignment
zlqk_dct = {
    '治疗方式': {},
    '靶向药-用药情况': [],
    '免疫药-用药情况': [],
...
zlqk_dct['治疗方式']['靶向'] = True
zlqk_dct['治疗方式']['免疫'] = True
zlqk_dct['治疗方式'] = zlqk_dct['治疗方式'].keys()
zlqk_dct['治疗方式']['靶向'] = True
